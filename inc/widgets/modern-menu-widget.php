...
// Start class
if ( ! class_exists( 'WPSP_Modern_Menu' ) ) {
	class WPSP_Modern_Menu extends WP_Widget {
		...
		function __construct() {
			...
			parent::__construct(
				'wpsp-modern-menu-widget',
	            $branding . esc_html__( 'Modern Sidebar Menu', 'wpsp_widget' ),
	            $widget_ops = array(
	                'classname'         => 'wpsp-modern-menu-widget',
	            )
			);
		}
...
// Register the widget
if ( ! function_exists( 'register_wpsp_modern_menu' ) ) {
	function register_wpsp_modern_menu() {
		register_widget( 'WPSP_Modern_Menu' );
	}
}
add_action( 'widgets_init', 'register_wpsp_modern_menu' );